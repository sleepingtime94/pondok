...
<style>
    ...
    #user-list li.active .badge {
        ...
        /* Badge lebih terlihat saat item aktif */
        color: #007bff;
    }
    ...
    #chat-messages {
        ...
        /* Menyusun pesan dari atas ke bawah */
        padding: 10px;
    }
    ...
    .message-container {
        max-width: 50%;
        /* Ubah ke 50% dari lebar area chat */
        display: flex;
        flex-direction: column;
    }
    ...
    .message-bubble {
        ...
        hyphens: auto;
        /* Menambahkan tanda hubung jika diperlukan */
        white-space: pre-wrap;
        /* Mempertahankan spasi dan line break */
    ...
    .message-wrapper.admin .message-bubble {
        ...
        /* Sudut yang menunjuk ke pengirim */
    }
    ...
    @media (max-width: 576px) {
        .message-container {
            max-width: 85%;
            /* Lebih lebar lagi di layar sangat kecil */
        }
    ...
    async function loadAllConversations() {
        try {
            ...
            const [conversationsResponse, unreadCountsResponse] = await Promise.all([
                fetch(`${SERVER_URL}/chat/messages/admin/${ADMIN_ID}`)
                , fetch(`${SERVER_URL}/chat/messages/unread/admin/${ADMIN_ID}`)
            ]);
