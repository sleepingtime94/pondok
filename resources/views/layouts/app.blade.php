...
<head>
    ...
    <style>
        ...
        .swiper-slide {
            ...
            align-items: center;
            aspect-ratio: 16 / 9; /* Opsional: jaga rasio gambar */
        ...
        .swiper-slide img {
            width: 100%;
            height: 100%;
            object-fit: contain; /* Penting: agar gambar tidak stretch */
            display: block;
        }
        ...
        .swiper-pagination-bullet {
            ...
            height: 8px; /* Ukuran lebih kecil */
            background-color: #9ca3af; /* Warna abu-abu muda */
        ...
        .swiper-pagination-bullet-active {
            background-color: #3b82f6; /* Biru (warna primary) */
            opacity: 1;
